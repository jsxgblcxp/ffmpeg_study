...
#include <stdio.h>
#include <unistd.h>
#define PICTURE_SLEEP_MICROSECOND 20000
...
int main(int argc, char *argv[]) {
        ...
        pSDLOverlay = SDL_CreateYUVOverlay( pCodecCtx->width * 1.5,
                                            pCodecCtx->height * 1.5,
                                            SDL_YV12_OVERLAY,
                                            screen);
        ...
        while(av_read_frame(pFormatCtx, &packet)>=0) {
                ...
                usleep( PICTURE_SLEEP_MICROSECOND );
        ...
        // Free the YUV frame
        //avcodec_free_frame(&pFrame); no define for this here 
